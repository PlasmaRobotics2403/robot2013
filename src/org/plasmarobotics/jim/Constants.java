...
public final class Constants {
    ...
    //Shoot kicker
    public static final int SHOOT_KICKER_FORWARD_CHANNEL = 1;
    public static final int SHOOT_KICKER_REVERSE_CHANNEL = 2;
    ...
    //Motor speeds
    public static final double FRONT_SHOOT_MOTOR_SPEED = 0.45;
    public static final double BACK_SHOOT_MOTOR_SPEED = 0.45;
    public static final double HIGH_MULTIPLIER = 2;
    public static final double HIGH_MAXIMUM = 0.9;
